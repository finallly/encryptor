...
class FrontWindow(object):
    def setup_ui(self, MainWindow) -> None:
        ...
        self.choiceBox.setGeometry(QtCore.QRect(440, 280, 351, 31))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(14)
        self.choiceBox.setFont(font)
        self.choiceBox.setStyleSheet(" background-color: rgb(215, 215, 215);\n"
                                     "  border: 1px solid gray;")
        self.choiceBox.setObjectName("choiseBox")
